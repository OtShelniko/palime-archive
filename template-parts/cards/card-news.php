...
<li class="card card--news <?php echo $section_slug ? 'section-' . esc_attr( $section_slug ) : ''; ?>" style="display:block;">
    <div class="card--news__inner flex flex--between flex--gap flex--wrap" style="gap:var(--spacing-md);">

        <!-- Левая часть: мета + заголовок -->
        <div class="card--news__content" style="flex:1; min-width:0;">
            <div class="card__meta card--news__meta mb-xs">
                <?php if ( $section_name ) : ?>
            ...
            <h3 class="card--news__title" style="font-family:var(--font-serif); font-size:1.05rem; line-height:1.4; font-weight:400;">
            ...
            <?php if ( has_excerpt( $post_id ) ) : ?>
                <p class="card--news__excerpt text-sm text-muted mt-xs" style="line-height:1.5;">
        ...
        <!-- Правая часть: кнопка -->
        <div class="card--news__aside" style="flex-shrink:0; align-self:center;">
            <a href="<?php echo esc_url( $permalink ); ?>" class="card--news__cta btn btn--ghost btn--sm">→</a>
        </div>
